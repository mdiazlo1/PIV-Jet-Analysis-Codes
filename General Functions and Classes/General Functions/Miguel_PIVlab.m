function [x,y,u,v,u_filt,v_filt] = Miguel_PIVlab(directory,suffix,Mask)
...
% directory = 'C:\Users\Lab-Admin\Downloads\T6\R1\1'; %directory containing the images you want to analyze
...
[filenames{1:length(direc),1}] = direc.name;
...
r{3,1}= 'Valid velocities [u_min; u_max; v_min; v_max]';    r{3,2}=[-800; 800; -100; 100];  % Maximum allowed velocities, for uncalibrated data: maximum displacement in pixels
